...
public class SuggestRecylViewAdapter extends RecyclerView.Adapter<SuggestRecylViewAdapter.HabitSuggestionViewHolder> {
    ...
    public HabitSuggestionViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        if (position >= 0 && data.get(position).isHeader()) {
            ...
            return new HabitSuggestionViewHolder(v, true);
        }
        View v = mLayoutInflater.inflate(R.layout.item_habit_sugggestion, viewGroup, false);
        return new HabitSuggestionViewHolder(v, false);
    }
    ...
    public class HabitSuggestionViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public HabitSuggestionViewHolder(@NonNull View itemView, boolean isHeader) {
            super(itemView);
            if (isHeader) {
